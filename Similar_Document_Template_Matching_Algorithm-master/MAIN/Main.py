...
def CHECK(document_type, image_path):
    ...
    template_folders = {
            "invoice": r"Similar_Document_Template_Matching_Algorithm-master\INVOICES",
            "prescription": r"Similar_Document_Template_Matching_Algorithm-master\PRESCRIPTIONS",
            "labreport": r"Similar_Document_Template_Matching_Algorithm-master\LABREPORTS"
    }
